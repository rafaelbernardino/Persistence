...
public class LivroDAO {
    ...
    public static String createTable() {
        return "CREATE TABLE " + Livro.TB_NAME + " ( "
    ...
    public String insereDado(Livro livro) {
        ...
        resultado = db.insert(Livro.TB_NAME, null, valores);
    ...
    public List<Livro> carregaDados() {
        ...
        cursor = db.query(Livro.TB_NAME, null, null, null, null, null, null, null);
    ...
    public Cursor carregaDadoById(int id) {
        ...
        db = DatabaseManager.getInstance().openDatabase(true);
        cursor = db.query(Livro.TB_NAME, campos, where, null, null, null, null, null);
    ...
    public void alteraRegistro(Livro livro) {
        ...
        db.update(Livro.TB_NAME, valores, where, null);
        DatabaseManager.getInstance().closeDatabase();
    }
    ...
    public void deletaRegistro(int id) {
        String where = Livro.ID + "=" + id;
        db = DatabaseManager.getInstance().openDatabase(false);
        db.delete(Livro.TB_NAME, where, null);
        DatabaseManager.getInstance().closeDatabase();
    }
}
